...
| `/api/laps` | GET | 過去ラップの一覧（ファイル名メタのみ・軽量） |
...
```json
{
    "total": 1104,
    "laps": [
        {"file": "2026-07-17_04_05_35_CAR-51_Lap-3.json", "recorded_at": "2026-07-17T04:05:35", "car_id": 51, "lap_number": 3, "size_bytes": 21055629}
    ]
}
```
