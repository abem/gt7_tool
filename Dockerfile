...
COPY index.html ./
COPY styles.css ./
COPY ui_components.js charts.js course-map.js websocket.js test-mode.js app.js car-3d.js constants.js lap-manager.js telemetry-analysis.js drive-view.js card-drag.js ./
